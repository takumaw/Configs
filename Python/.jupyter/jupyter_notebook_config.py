...
MY_CERT_FILE = os.path.abspath(os.path.expanduser(u'~/.jupyter/cert.pem'))
if os.path.isfile(MY_CERT_FILE):
    c.NotebookApp.certfile = MY_CERT_FILE
...
MY_PASSWD_FILE = os.path.abspath(os.path.expanduser(u'~/.jupyter/passwd'))
if os.path.isfile(MY_PASSWD_FILE):
    with open(MY_PASSWD_FILE) as f:
